...
class Profile:
    def __init__(self):
        self.name = "Alyan Malik"
        self.title = "Full-Stack Developer | Machine Learning Engineer | Problem Solver"
        self.skills = [
            "Laravel", "PHP", "Flask", "Python", "JavaScript",
            "MySQL", "SQLite", "Docker", "REST APIs", "Machine Learning",
            "Deep Learning", "Computer Vision", "Web Scraping Engineer",
            "Git", "Github"
        ]
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                Full-Stack Developer & Machine Learning Engineer specializing in Laravel, Python, and intelligent web applications with expertise in ML, DL, Computer Vision, and Data Automation. 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://linkedin.com/in/alyan-malik" target="_blank"
                ...
                {/* Contact Button */}
                <a
                  href="src/assets/files/Alyan Resume.pdf" target="_blank"
